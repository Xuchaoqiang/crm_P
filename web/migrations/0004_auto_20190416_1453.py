    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, '未报名'), (2, '已报名')], default=2, verbose_name='状态')),
                ...
                ('work_status', models.IntegerField(blank=True, choices=[(1, '在职'), (2, '无职')], default=1, null=True, verbose_name='职业状态')),
                ...
                ('referral_form', models.ForeignKey(blank=True, help_text='若此客户是转介绍自内部学员,请在此处选择内部学员姓名', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='internal_referral', to='web.Customer', verbose_name='转介绍自学员')),
            ],
        ),
